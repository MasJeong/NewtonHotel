...
<form name="frm" method="post" action="BoardServlet">
	...
	<table>
		...
		<tr>
			<th>이메일</th>
			<td><input type="text" size="100" maxlength="50" name="email" value="${board.email }"></td>
		</tr>
		<tr>
			<th>제목</th>
			<td><input type="text" size="240" name="title" value="${board.title }"></td>
		</tr>
		<tr>
			<th>내용</th>
			<td><textarea cols="240" rows="15" name="content">${board.content }</textarea></td>
		</tr>
	</table>
	<br><br>
