...
<meta name="viewport" content="width=device-width, initial-scale=1">
	...
	<title>Suite Room(Spa) &#8211; 얼레이호텔</title>
...
<link rel="canonical" href="http://alleehotel.com/home/suite-rooms/" />
<link rel='shortlink' href='http://alleehotel.com/?p=4416' />
<link rel="alternate" type="application/json+oembed" href="http://alleehotel.com/wp-json/oembed/1.0/embed?url=http%3A%2F%2Falleehotel.com%2Fhome%2Fsuite-rooms%2F" />
<link rel="alternate" type="text/xml+oembed" href="http://alleehotel.com/wp-json/oembed/1.0/embed?url=http%3A%2F%2Falleehotel.com%2Fhome%2Fsuite-rooms%2F&#038;format=xml" />
<meta name="generator" content="Powered by Slider Revolution 5.4.5.1 - responsive, Mobile-Friendly Slider Plugin for WordPress with comfortable drag and drop interface." />
				<style type="text/css" media="all"
				       id="siteorigin-panels-layouts-head">/* Layout 4416 */ #pgc-4416-0-0 { width:21.9964%;width:calc(21.9964% - ( 0.78003633291718 * 30px ) ) } #pgc-4416-0-1 { width:78.0036%;width:calc(78.0036% - ( 0.21996366708282 * 30px ) ) } #pl-4416 .so-panel { margin-bottom:30px } #pl-4416 .so-panel:last-child { margin-bottom:0px } #pg-4416-0.panel-no-style, #pg-4416-0.panel-has-style > .panel-row-style { -webkit-align-items:flex-start;align-items:flex-start } @media (max-width:780px){ #pg-4416-0.panel-no-style, #pg-4416-0.panel-has-style > .panel-row-style { -webkit-flex-direction:column;-ms-flex-direction:column;flex-direction:column } #pg-4416-0 .panel-grid-cell { margin-right:0 } #pg-4416-0 .panel-grid-cell { width:100% } #pgc-4416-0-0 { margin-bottom:30px } #pl-4416 .panel-grid-cell { padding:0 } #pl-4416 .panel-grid .panel-grid-cell-empty { display:none } #pl-4416 .panel-grid .panel-grid-cell-mobile-last { margin-bottom:0px }  } </style><link rel="icon" href="http://alleehotel.com/wp-content/uploads/2017/08/allee-1-32x32.png" sizes="32x32" />
...
<body class="page-template-default page page-id-4416 page-child parent-pageid-4497  wrapper-header_overlay wrapper-header_v1 siteorigin-panels siteorigin-panels-before-js">
...
<article id="post-4416" class="post-4416 page type-page status-publish hentry">
	<div class="entry-content">
		<div id="pl-4416"  class="panel-layout" ><div id="pg-4416-0"  class="panel-grid panel-no-style" ><div id="pgc-4416-0-0"  class="panel-grid-cell" ><div id="panel-4416-0-0-0" class="so-panel widget widget_black-studio-tinymce widget_black_studio_tinymce panel-first-child panel-last-child" data-index="0" ><h3 class="widget-title">Accommodation</h3><div class="textwidget"><div id="sidebar" class="" role="">
<div class="sidebar">
...
<p>&nbsp;</p>
</div></div></div><div id="pgc-4416-0-1"  class="panel-grid-cell" ><div id="panel-4416-0-1-0" class="so-panel widget widget_black-studio-tinymce widget_black_studio_tinymce panel-first-child panel-last-child" data-index="1" ><div class="textwidget"><div id="room-2303" class="hb_single_room post-2303 hb_room type-hb_room status-publish has-post-thumbnail hentry hb_room_type-spa-room">
<div class="summary entry-summary">
<div class="title">
<h4><a href="http://alleehotel.com/home/suite-rooms/">스위트 스파룸</a></h4>
</div>
...
<ul class="slides">
<li><img src="http://alleehotel.com/wp-content/uploads/2014/01/805호-5-1920x1280.jpg" /></li>
<li><img src="http://alleehotel.com/wp-content/uploads/2014/01/805호-4-1920x1280.jpg" /></li>
<li><img src="http://alleehotel.com/wp-content/uploads/2014/01/805호-3-1920x1280.jpg" /></li>
<li><img src="http://alleehotel.com/wp-content/uploads/2014/01/805호-2-1920x1280.jpg" /></li>
<li><img src="http://alleehotel.com/wp-content/uploads/2014/01/805호-1-1920x1280.jpg" /></li>
</ul>
</div>
...
<p><b class="thim-color-title">얼레이 호텔 최고층에 준비한 듀플렉스 스위트는 가족여행, 친구, 회사 모임이나 파티 등으로 활용할수 있습니다.<br /> 전용가든은 도시를 벗어나 숲속 정취를 느낄 수 있으며 사우나실이 별도로 설치되어 있어 여유롭게 즐길 수 있습니다.</b></p>
<p> </p>
<h5>객실정보</h5>
<p class="marker"><strong>구성<br /> </strong>스위트 스파룸 더블침대1, 고급월풀욕조, 독립형샤워부스, 사우나실</p>
<p class="marker"><strong>위치<br /> </strong>본관 (805호)</p>
<p class="marker"><strong>주요시설<br /> </strong>개별 냉난방 시스템, 삼성 50″ LED TV, 업무용 책상 및 의자, 비데, 냉장고, 전기포트, 정원테이블</p>
...
<h3 id="reply-title" class="comment-reply-title">Be the first to review “Suite Room(Spa)” <small><a id="cancel-comment-reply-link" style="display: none;" href="/home/suite-rooms/#respond" rel="nofollow">응답 취소</a></small></h3>
...
<p class="form-submit"><input id="submit" class="submit" name="submit" type="submit" value="Submit" /> <input id="comment_post_ID" name="comment_post_ID" type="hidden" value="2303" /><br /> <input id="comment_parent" name="comment_parent" type="hidden" value="0" /></p>
<p><input id="_wp_unfiltered_html_comment_disabled" name="_wp_unfiltered_html_comment_disabled" type="hidden" value="5dbda0dfb5" /><script>(function(){if(window===window.parent){document.getElementById('_wp_unfiltered_html_comment_disabled').name='_wp_unfiltered_html_comment';}})();</script></p>
</form>
</div>
<p><!-- #respond --></p>
</div>
...
<h4 class="hb_room_pricing_plan_data">스위트 스파룸 객실요금</h4>
...
<script type='text/javascript'>
/* <![CDATA[ */
var kboard_settings = {"version":"5.3.4","home_url":"\/","site_url":"\/","post_url":"http:\/\/alleehotel.com\/wp-admin\/admin-post.php","alax_url":"http:\/\/alleehotel.com\/wp-admin\/admin-ajax.php","plugin_url":"http:\/\/alleehotel.com\/wp-content\/plugins\/kboard","media_group":"60faca99ed7d7","ajax_security":"15323b60cf"};
