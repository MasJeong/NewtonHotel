...
<body>
	...
	<div style="padding: 10px; margin: 0 auto; width: 350px; height: auto;">
		...
		<form action="MemberServlet?command=admin_pwd_update_action" method="post" name="frm">
			...
			<input type="button" class="button1" value="이전페이지" onclick="history.go(-1)">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
			<input type="submit" value="확인" class="button1" onclick="return updateCheck()">
