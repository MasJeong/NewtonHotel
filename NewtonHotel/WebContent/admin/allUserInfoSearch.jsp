	...
	<div class="wrap">
		...
		<div class="listContainer">
			<div style="padding: 10px; margin: 0 auto; width: 1100px; height: auto;">
					...
					<form name="search" method="post" action="MemberServlet?command=member_search_action">
						<fieldset>
							...
							<select name="keyField">
								...
								<option ${(param.keyField == "name")? "selected" : "" } value="name">이름</option>
							</select> 
							<label>검색어</label> 
				...
				<br>
				<p>
				<input type="button" class="button" value="모든목록 조회" onclick="location.href='MemberServlet?command=all_user_info_select'" style="float: right;">
				</p>
			</div>
		</div>
	</div>
