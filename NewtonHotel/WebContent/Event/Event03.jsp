	...
	<div class="container">
		<div class="row">
			...
			<center>
				...
				<p style=font-size:15px> 안녕하세요 NEWTON입니다 무더운 여름맞이 호캉스 이벤트를 열었습니다<br><br>
				무더운 여름에 어디 나가지 마시고 저희 호텔에서 호캉스를 보내세요 호캉스를 저희 호텔에서 즐겨주시는 분들은 수영장 1회 무료 입장권을 드립니다.<br><br>
				※이벤트 적용대상은 2인 이하로 호텔을 이용해주시는 고객님에 대해서 해당이 됩니다.
				</p>
			</div>
			<div class="col-1"></div>
		</div>
