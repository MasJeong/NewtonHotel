...
<body>
	...
	<div id="wrap" align="center">
		...
		<table>
			...
			<!-- 			<tr> -->
			<!-- 				<th>작성일</th> -->
			<%-- 				<td><fmt:formatDate value="${askView.posted }" /></td> --%>
			<!-- 				<th>조회수</th> -->
			<%-- 				<td>${askView.readcount }</td> --%>
			<!-- 			</tr> -->
			<tr>
				<th>제목</th>
				<td colspan="3"><pre>${askView.title }</pre></td>
			</tr>
			<c:if test="${askView.file_name != null }">
				<th>사진</th>
				<td colspan="3"><pre>

							<img src="upload/${askView.file_name }" alt=" " class="img1"> 
			...
			<tr>
				<th>내용</th>
				<td colspan="3"><pre>${askView.content }</pre></td>

			</tr>
		</table>
		<br> <br> <input type="button" value="수정"
			onclick="location.href='AskServlet?command=ask_update_form&num=${askView.num}'">
		<input type="button" value="삭제"
			onclick="location.href='AskServlet?command=ask_delete&num=${askView.num}'">
