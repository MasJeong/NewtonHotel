...
<script type="text/javascript">
	...
	function jusoCallBack(roadAddrPart1){
		document.frm.map.value = roadAddrPart1;
	...
	<div style="padding: 10px; margin: 0 auto; width: 350px; height: auto;">
		...
		<form action="join.do" method="post" name="frm">
			<div class = "form-group">
				(필수)<input type="text" name="name" size="20" class="form-control" placeholder="이름" autocomplete="off">	 
			</div>
			<div class = "form-group">
				(필수)<input type="text" name="userid" size="20" id="userid" class="form-control" placeholder="아이디" autocomplete="off">
				<input type="hidden" name="reid" size="20">
				<input type="button" class="button1" value="중복 체크"	onclick="idCheck()">	 
			</div> 
			<div class = "form-group"> 
				(필수)<input type="password" name="pwd" size="20" class="form-control" placeholder="비밀번호">
			</div>
			<div class = "form-group"> 
				(필수)<input type="password" name="pwd_check" size="20" class="form-control" placeholder="비밀번호 확인">
			</div>
			<div class = "form-group">
				(필수)<input type="text" name="phone" size="20" class="form-control" placeholder="전화번호" autocomplete="off">
			</div>
			<div class = "form-group">
				<input type="text" name="email" size="20" class="form-control" placeholder="이메일" autocomplete="off">
			</div>
			<div class = "form-group">
				<input type="text" id="map" name="map" size="20" class="form-control" placeholder="주소" readonly>
				<input type="button" class="button1" onClick="goPopup();" value="주소 검색" />
			</div>
			<input type="hidden" name="admin" value="0">
			<div class = "form-group">
				<input type="checkbox" name="agree" value="first"> 뉴튼 호텔 이용약관 동의<font color="blue">(필수)</font> <br>
				<input type="checkbox" name="agree" value="second"> 개인정보 수집 및 이용 동의<font color="blue">(필수)</font>
			</div>
			<div class = "form-group"> 	 
				<input type="submit" class="button" value="회원가입" onclick="return joinChk()">
			</div>
	</form>
	</div>
	<!-- footer -->
